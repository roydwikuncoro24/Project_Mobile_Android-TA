...
public class AdminBerandaAdapter extends RecyclerView.Adapter<AdminBerandaAdapter.HolderData> {

    List<PenjualanModelData> penjualanList;
    Fragment fragment;

    public AdminBerandaAdapter(ArrayList<PenjualanModelData> penjualanList, Fragment fragment) {
        this.penjualanList = penjualanList;
        this.fragment = fragment;
    }

    @Override
    public AdminBerandaAdapter.HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_penjualan, parent, false);
        AdminBerandaAdapter.HolderData holderData = new AdminBerandaAdapter.HolderData(v);
        return holderData;
    }

    @Override
    public void onBindViewHolder(AdminBerandaAdapter.HolderData holder, int position) {
