...
public class AdminTanggunganAdapter extends RecyclerView.Adapter<AdminTanggunganAdapter.HolderData>{
    List<BayarTanggunganModelData> resultBayar;
    List<TanggunganModelData> resultTang;
    Context context;

    public AdminTanggunganAdapter(ArrayList<BayarTanggunganModelData> resultBayar, ArrayList<TanggunganModelData> resultTangg, Context context) {
        this.resultBayar = resultBayar;
        this.resultTang = resultTangg;
        this.context = context;
    }

    @Override
    public AdminTanggunganAdapter.HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_pembayaran, parent, false);
        AdminTanggunganAdapter.HolderData holderData = new AdminTanggunganAdapter.HolderData(v);
        return holderData;
    }

    @Override
    public void onBindViewHolder(AdminTanggunganAdapter.HolderData holder, int position) {
    ...
    public class HolderData extends RecyclerView.ViewHolder{
        ...
        public TextView tvBayar, tvToko, tvTanggal;
        public String id;
    ...
    public void updateList(ArrayList<BayarTanggunganModelData> list, ArrayList<TanggunganModelData> listRec) {
        resultBayar = list;
        resultTang = listRec;
