...
public class KaryawanPenjualan extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String timeStamp = "";
    LinearLayout linMPL, linNilaiMPL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linMPL = findViewById(R.id.linMPLpenjualan);
        linNilaiMPL = findViewById(R.id.linNilaiMPLpenjualan);
        linMPL.setVisibility(View.GONE);
        linNilaiMPL.setVisibility(View.GONE);
        recyclerView = (RecyclerView) findViewById(R.id.recPenjualan);
        tpAdapter = new TokoPenjualanAdapter(penjualanList, KaryawanPenjualan.this);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(
                KaryawanPenjualan.this, LinearLayoutManager.VERTICAL, false);
        ...
        adapter = new ArrayAdapter<String>(KaryawanPenjualan.this, android.R.layout.simple_spinner_item, arrayTipe);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menuRecTrans:
                Intent intent = new Intent(KaryawanPenjualan.this, TokoRecTransaksi.class);
        ...
        call.enqueue(new Callback<GetTipeBarangResponse>() {
            ...
            public void onFailure(Call<GetTipeBarangResponse> call, Throwable t) {
                if (t instanceof SocketTimeoutException) {
                    swipeContainer.setRefreshing(false);
                    Toast.makeText(KaryawanPenjualan.this, "Harap periksa koneksi internet", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        call.enqueue(new Callback<PenjualanGetResponse>() {
            ...
            public void onResponse(Call<PenjualanGetResponse> call, Response<PenjualanGetResponse> response) {
                ...
                if (response.body().getStatus_code().equals("1")) {
                    ...
                    swipeContainer.setRefreshing(false);
                    Toast.makeText(KaryawanPenjualan.this, "Tidak ada penjualan", Toast.LENGTH_SHORT).show();
                }
            }
