...
public class KaryawanBerhasilTransaksi extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        karyawan = tinyDB.getObject("karyawan_login",KaryawanModelData.class);
        ...
        btnTransLagi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                KaryawanListTransaksi.klTransaksiActivity.setResult(111);
                KaryawanListTransaksi.klTransaksiActivity.finish();
                KaryawanInputBayarTransaksi.kinputBayarActivity.finish();
                finish();
            }
        });
        ...
        try {
            ...
            mPrinter.connectPrinter(new BluetoothPrinter.PrinterConnectListener() {
                ...
                public void onConnected() {
                    ...
                    mPrinter.printCustom("Petugas:"+karyawan.getNamakaryawan(),1,1);
                    printContent = printContent+"\n"+toko.getNamatoko();
            ...
            Toast.makeText(KaryawanBerhasilTransaksi.this,"Belum setting perangkat bluetooth",
