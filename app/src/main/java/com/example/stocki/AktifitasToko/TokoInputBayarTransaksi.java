...
public class TokoInputBayarTransaksi extends AppCompatActivity {
    ...
    String bayar = "";
    public static Activity tinputBayarActivity;
        ...
        switch (item.getItemId()) {
            case R.id.menuLanjut:
                ...
                if ((jual<=Integer.parseInt(bayar))) {
                    ...
                    Toast.makeText(TokoInputBayarTransaksi.this,"Jumlah bayar kurang",Toast.LENGTH_SHORT).show();
                }
                return true;
            default:
        ...
        call.enqueue(new Callback<InsertResponse>() {
            ...
            public void onResponse(Call<InsertResponse> call, Response<InsertResponse> response) {
                ...
                if (response.body().getStatus_code().equals("1")) {
                    ...
                    Intent intent = new Intent(tinputBayarActivity, TokoBerhasilTransaksi.class);
                    ...
                    Toast.makeText(TokoInputBayarTransaksi.this,"TokoTransaksi gagal",Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onFailure(Call<InsertResponse> call, Throwable t) {
                if (t instanceof SocketTimeoutException) {
                    dialog.dismiss();
                    Toast.makeText(TokoInputBayarTransaksi.this, "Harap periksa koneksi internet", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
