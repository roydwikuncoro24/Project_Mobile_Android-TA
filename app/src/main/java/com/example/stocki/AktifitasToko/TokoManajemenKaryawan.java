...
public class TokoManajemenKaryawan extends AppCompatActivity {

    TokoKaryawanAdapter mAdapter;
    List<KaryawanModelData> mdKaryawan = new ArrayList<>();
    ...
    public static Activity tmKaryawan;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_mitrakaryawan);
        getSupportActionBar().setTitle("Manajemen Karyawan");
        ...
        dialog = new SpotsDialog(TokoManajemenKaryawan.this, "Memuat data...");
        ...
        mAdapter = new TokoKaryawanAdapter(mdKaryawan, TokoManajemenKaryawan.this);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager
                (TokoManajemenKaryawan.this, LinearLayoutManager.VERTICAL, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TokoManajemenKaryawan.this, TokoTambahKaryawan.class);
    ...
    public void getListUser() {
        ...
        Call<GetMitraNKaryawan> call = api.showKaryawan(((TokoModelData) tinyDB.getObject("toko_login", TokoModelData.class)).getIdtoko());
        ...
        call.enqueue(new Callback<GetMitraNKaryawan>() {
            ...
            public void onResponse(Call<GetMitraNKaryawan> call, Response<GetMitraNKaryawan> response) {
                if (response.body().getStatus_code().equals("1")) {
                    mAdapter.clear();
                    mAdapter.addAll(response.body().getResult_karyawan());
                    swipeContainer.setRefreshing(false);
                    dialog.dismiss();
                }else{
                    dialog.dismiss();
                    swipeContainer.setRefreshing(false);
                    Toast.makeText(TokoManajemenKaryawan.this,"Tdiak Ada Data",Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onFailure(Call<GetMitraNKaryawan> call, Throwable t) {
                if (t instanceof SocketTimeoutException) {
                    swipeContainer.setRefreshing(false);
                    dialog.dismiss();
                    Toast.makeText(TokoManajemenKaryawan.this, "Harap periksa koneksi internet", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
