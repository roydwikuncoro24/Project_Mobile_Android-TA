...
public class TokoBarang extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
...
//        });
        ...
        gridButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                modeView = 1;
                bAdapter = new TokoBarangAdapter(resultBarang, TokoBarang.this,0);
                recyclerView.setLayoutManager(new GridLayoutManager(TokoBarang.this, 3));
        ...
        listButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                modeView = 0;
                bAdapter = new TokoBarangAdapter(resultBarang, TokoBarang.this,1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(TokoBarang.this, LinearLayoutManager.VERTICAL, false);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(TokoBarang.this,
...
//        swipeContainer.setOnRefreshListener(this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TokoBarang.this, TokoInputBarang.class);
                startActivity(intent);
            }
        });

        adapter = new ArrayAdapter<String>(TokoBarang.this, android.R.layout.simple_spinner_item, arraytipe);
...
//                    TokoList.addAll(response.body().getResult_mitra());
                    ...
                    Toast.makeText(TokoBarang.this, "Belum ada barang", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<GetTipeBarangResponse> call, Throwable t) {
                if (t instanceof SocketTimeoutException) {
                    swipeContainer.setRefreshing(false);
                    Toast.makeText(TokoBarang.this, "Harap periksa koneksi internet", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void getListBarang(){
        APIService api = RetrofitHelper.getClient().create(APIService.class);
        Call<BarangGetResponse> call = api.showBarangToko(((TokoModelData)tinyDB.getObject("toko_login", TokoModelData.class)).getIdtoko());
        System.out.println("masuk");
...
//                    tes();
                    ...
                    swipeContainer.setRefreshing(false);
                    Toast.makeText(TokoBarang.this,"Tidak ada barang",Toast.LENGTH_SHORT).show();
                }
            }
            @Override
