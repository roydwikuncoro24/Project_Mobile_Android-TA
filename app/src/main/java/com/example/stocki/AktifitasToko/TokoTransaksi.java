...
public class TokoTransaksi extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static Activity TokoTransaksi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barcodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IntentIntegrator scanIntegrator = new IntentIntegrator(TokoTransaksi);
        ...
        gridButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                modeView = 1;
                tokoTransaksiAdapter = new TokoTransaksiAdapter(transaksiList, com.example.stocki.AktifitasToko.TokoTransaksi.this,0);
                recyclerView.setLayoutManager(new GridLayoutManager(com.example.stocki.AktifitasToko.TokoTransaksi.this, 3));
        ...
        listButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                modeView = 0;
                tokoTransaksiAdapter = new TokoTransaksiAdapter(transaksiList, com.example.stocki.AktifitasToko.TokoTransaksi.this,1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(com.example.stocki.AktifitasToko.TokoTransaksi.this, LinearLayoutManager.VERTICAL, false);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(com.example.stocki.AktifitasToko.TokoTransaksi.this,
        ...
        btnLanjut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (getJum() > 0) {
                    Intent intent = new Intent(com.example.stocki.AktifitasToko.TokoTransaksi.this, TokoListTransaksi.class);
                    Bundle bundle = new Bundle();
                    bundle.putParcelableArrayList("list", transaksiarrayList);
                    intent.putExtras(bundle);
                    startActivityForResult(intent, 123);
                } else {
                    Toast.makeText(com.example.stocki.AktifitasToko.TokoTransaksi.this,
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 123) {
            ...
            if (result.getContents() != null) {
                ...
                edtSearch.setText(scanContent);
//                showDialogBarcode(result.getContents());
                Toast.makeText(com.example.stocki.AktifitasToko.TokoTransaksi.this, result.getContents(), Toast.LENGTH_SHORT).show();
            }else {
    ...
    public void getListBarang() {
        ...
        Call<BarangGetResponse> call = api.
                showBarangToko(((TokoModelData) tinyDB.getObject("toko_login", TokoModelData.class)).getIdtoko());
...
//                    tes();
                    ...
                    dialog.dismiss();
                    Toast.makeText(com.example.stocki.AktifitasToko.TokoTransaksi.this, "Tidak ada barang", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onFailure(Call<BarangGetResponse> call, Throwable t) {
                if (t instanceof SocketTimeoutException) {
                    dialog.dismiss();
                    Toast.makeText(com.example.stocki.AktifitasToko.TokoTransaksi.this, "Harap periksa koneksi internet",
        ...
        for (BarangModelData b : barangList) {
            if (Integer.parseInt(b.getStok()) > 0) {
                transaksiList.add(new
                        TransaksiProses(b.getId(),b.getIdadmin(), b.getNamabarang(),b.getKode(),
                        "0", b.getHargadasar(), b.getStok(), b.getHargajual(),
                        b.getHargajualtoko(), "1", b.getImage(),b.getidTipe()));
            }
        }
        jum = 0;
    ...
    public void showDialogBarcode(final String kode){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(com.example.stocki.AktifitasToko.TokoTransaksi.this);
                ...
                if(!edtJumlah.getText().toString().equals("")){
                    for (BarangModelData b : barangList){
                        ...
                        if (b.getKode().equals(kode)){
                            ...
                            btnLanjut.setText("Lanjut > "+ getJum());
                            break;
                        }
                    }
                    if (i==0){
                        Toast.makeText(com.example.stocki.AktifitasToko.TokoTransaksi.this, "Barang tidak ditemukan", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(com.example.stocki.AktifitasToko.TokoTransaksi.this, "Nama dan Harga harap diisi", Toast.LENGTH_SHORT).show();
                }
            }
        });
