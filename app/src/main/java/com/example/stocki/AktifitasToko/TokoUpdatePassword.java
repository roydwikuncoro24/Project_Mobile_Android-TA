...
public class TokoUpdatePassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog =  new SpotsDialog(TokoUpdatePassword.this, "Loading...");

        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isEmpty(sandi)||isEmpty(csandi)) {
                    Toast.makeText(TokoUpdatePassword.this,
    ...
    public void updatePass(){
        ...
        Call<InsertResponse> call = api.
                updatePassToko(((TokoModelData) tinyDB.getObject("toko_login",
                        TokoModelData.class)).getIdtoko(),
        ...
        call.enqueue(new Callback<InsertResponse>() {
            ...
            public void onResponse(Call<InsertResponse> call, Response<InsertResponse> response) {
                ...
                if (response.body().getStatus_code().equals("1")) {
                    dialog.dismiss();
                    TokoModelData toko = ((TokoModelData) tinyDB.getObject(
                            "toko_login", TokoModelData.class));
                    tinyDB.putObject("toko_login", toko);
                    Intent intent = new Intent(TokoUpdatePassword.this, Login.class);
