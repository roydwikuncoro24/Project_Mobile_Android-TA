...
public class TokoListTransaksi extends AppCompatActivity {
    ...
    public static Activity tlTransaksiActivity;
...
//        toko = tinyDB.getObject("toko_login",TokoModelData.class);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(TokoListTransaksi.this, LinearLayoutManager.VERTICAL, false);
...
//        }
        ...
        lanjutListtransaksi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(tlTransaksiActivity, TokoInputBayarTransaksi.class);
...
//                addTransaksi();
    ...
    public void showEditTransaksi(final int posisi, Drawable image, String nama, String harga, String jumlah){
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(TokoListTransaksi.this);
    ...
    public void addTransaksi(){
        ...
        Penjualan penjualan = new Penjualan(
                ...
                ((TokoModelData)tinyDB.getObject("toko_login", TokoModelData.class)).getNamapemilik(),
        ...
        call.enqueue(new Callback<InsertResponse>() {
            ...
            public void onResponse(Call<InsertResponse> call, Response<InsertResponse> response) {
                ...
                if (response.body().getStatus_code().equals("1")) {
                    ...
                    Intent intent = new Intent(TokoListTransaksi.this, TokoBerhasilTransaksi.class);
                    Bundle bundle = new Bundle();
                    bundle.putParcelableArrayList("list", arrayList);
                    intent.putExtras(bundle);
                    ...
                    Toast.makeText(TokoListTransaksi.this,"TokoTransaksi gagal",Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onFailure(Call<InsertResponse> call, Throwable t) {
                if (t instanceof SocketTimeoutException) {
                    dialog.dismiss();
                    Toast.makeText(TokoListTransaksi.this, "Harap periksa koneksi internet", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
